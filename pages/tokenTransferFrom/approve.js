		...
		if( window.ethereum ){
			...
			try{
				...
				*/
				...
				var paragraph = '<p id="transactionSuccessMessage" style="">Approve <span class="amount">'+amount+'</span> Token to Address : <span class="amount">'+recepientAccountAddress+'</span> Success</p>';
				var aTag = 	'<a target="_blank" tyle="" id="transactionDetailsLink" href="https://rinkeby.etherscan.io/tx/'+TransactionHash+'">';
			...
			<Layout>
				<div id="transferPageWrapper">
					...
					<Form onSubmit={this.onApprove} error={!!this.state.errorMessage}>
						...
						<Button loading={this.state.loading} primary>Approve</Button>
